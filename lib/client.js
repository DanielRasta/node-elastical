...
Client.prototype = {
    ...
    **/
    getIndex: function (name) {
     ...
     put: wrapStaticIndexMethod('put'),
     post: wrapStaticIndexMethod('post'),
...
if(options == null)
{
  throw "empty options is empty.";
        ...
        this._request(url, {
            ...
            if (err) { return callback(err, "false", res), undefined; }
            callback && callback(null, res.ok, res);
        });
    },
